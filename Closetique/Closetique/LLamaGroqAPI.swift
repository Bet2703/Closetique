...
class LlamaGroqAPI {
    ...
    private static func generateOutfitComboInternal(
        ...
        <id1>;<id2>;<id3>;... | <descrizione creativa e sintetica dell'outfit, con voto X/10 e motivazione. Se non hai rispettato le regole, spiega l'errore nella descrizione. Il voto deve essere estremamente severo.
    ...
    static func generateOutfitWithFixedItem(
        ...
        Rispondi SOLO in questo formato, senza nessun testo extra:
        <id1>;<id2>;<id3>;... | <descrizione creativa e sintetica dell'outfit, con voto X/10 e motivazione. Se non hai rispettato le regole, spiega l'errore nella descrizione. Il voto deve essere severo.
