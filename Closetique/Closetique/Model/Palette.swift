...
/// Struttura base per la gestione del colore associato al suo nome
struct PaletteColor {
    let color: Color
    let name: String
}

/// Struttura che gestisce 4 array di PaletteColor contenenti ciascuno 30 colori relativi alla stagione di riferimento
struct Palette {
